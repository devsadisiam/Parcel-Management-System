 ...
 <header class="bg-white bg-cover bg-no-repeat bg-center" style="background-image: url('assets/parcel_home_bg.png');">
  ...
  <div class="container mx-auto px-6">
    <div class="bg-white rounded-xl shadow-lg p-8 max-w-2xl mx-auto">
      ...
      <!-- Form added -->
      <form action="tracking.php" method="get" class="flex">
        <input 
          type="text" 
          name="tracking_id"
          placeholder="Enter tracking number" 
          class="flex-grow px-4 py-3 border rounded-l-lg focus:outline-none" 
          required
        />
        <button 
          type="submit" 
          class="px-6 py-3 bg-primary text-white rounded-r-lg hover:bg-orange-600"
        >
          Track
        </button>
      </form>
